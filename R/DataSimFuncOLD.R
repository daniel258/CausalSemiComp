...
SimDataWeibFrailOLD <- function(n.sample, params, no.protected = T, no.large = T, cens.exp.rate = 0.1)
{
  ...
  while (cond.sample==F) {
    ...
    if(length(gamma.shape)==2)
    {
      ...
      scale.a0.01 <- (exp( log(gamma.vec0) + (X %*% beta.a0.01)))^(base.weib.shape.a0.01 - 2) *
        base.weib.scale.a0.01
      scale.a1.01 <- (exp( log(gamma.vec1) + (X %*% beta.a1.01)))^(base.weib.shape.a1.01 - 2) *
        base.weib.scale.a1.01
      scale.a0.02 <- (exp( log(gamma.vec0) + (X %*% beta.a0.02)))^(base.weib.shape.a0.02 - 2) *
        base.weib.scale.a0.02
      scale.a1.02 <- (exp( log(gamma.vec1) + (X %*% beta.a1.02)))^(base.weib.shape.a1.02 - 2) *
        base.weib.scale.a1.02
      scale.a0.12 <- (exp( log(gamma.vec0) + (X %*% beta.a0.12)))^(base.weib.shape.a0.12 - 2) *
        base.weib.scale.a0.12
      scale.a1.12 <- (exp( log(gamma.vec1) + (X %*% beta.a1.12)))^(base.weib.shape.a1.12 - 2) *
        base.weib.scale.a1.12
    } else {
   ...
   # scale.a0.01 <- exp( -log(gamma.vec) - (X %*% beta.a0.01)) * base.weib.scale.a0.01
    ...
    #scale.a1.12 <- exp( -log(gamma.vec) - (X %*% beta.a1.12)) * base.weib.scale.a1.12
     # scale.a0.01 <- exp(  - (X %*% beta.a0.01)) * base.weib.scale.a0.01
     # scale.a1.01 <- exp(  - (X %*% beta.a1.01)) * base.weib.scale.a1.01
     # scale.a0.02 <- exp(  - (X %*% beta.a0.02)) * base.weib.scale.a0.02
     # scale.a1.02 <- exp(  - (X %*% beta.a1.02)) * base.weib.scale.a1.02
     # scale.a0.12 <- exp(  - (X %*% beta.a0.12)) * base.weib.scale.a0.12
     # scale.a1.12 <- exp(  - (X %*% beta.a1.12)) * base.weib.scale.a1.12
     scale.a0.01 <- (exp(log(gamma.vec) + (X %*% beta.a0.01)))^(base.weib.shape.a0.01 - 2) *
       base.weib.scale.a0.01
     scale.a1.01 <- (exp(log(gamma.vec) + (X %*% beta.a1.01)))^(base.weib.shape.a1.01 - 2) *
       base.weib.scale.a1.01
     scale.a0.02 <- (exp(log(gamma.vec) + (X %*% beta.a0.02)))^(base.weib.shape.a0.02 - 2) *
       base.weib.scale.a0.02
     scale.a1.02 <- (exp(log(gamma.vec) + (X %*% beta.a1.02)))^(base.weib.shape.a1.02 - 2) *
       base.weib.scale.a1.02
     scale.a0.12 <- (exp(log(gamma.vec) + (X %*% beta.a0.12)))^(base.weib.shape.a0.12 - 2) *
       base.weib.scale.a0.12
     scale.a1.12 <- (exp(log(gamma.vec) + (X %*% beta.a1.12)))^(base.weib.shape.a1.12 - 2) *
       base.weib.scale.a1.12
    }
